...
/**
 * This class stands for AxdEntity_DocuRefLine StructType
 * @subpackage Structs
 */
class AxdEntity_DocuRefLine extends AbstractStructBase
{
    /**
     * The class
    ...
    public $action;
    /**
     * Constructor method for AxdEntity_DocuRefLine
     * @uses AxdEntity_DocuRefLine::setClass()
     * @uses AxdEntity_DocuRefLine::setActualCompanyId()
     * @uses AxdEntity_DocuRefLine::setAuthorId()
     * @uses AxdEntity_DocuRefLine::setContactPersonId()
     * @uses AxdEntity_DocuRefLine::setEncyclopediaItemId()
     * @uses AxdEntity_DocuRefLine::setName()
     * @uses AxdEntity_DocuRefLine::setNotes()
     * @uses AxdEntity_DocuRefLine::setPartyId()
     * @uses AxdEntity_DocuRefLine::setRecId()
     * @uses AxdEntity_DocuRefLine::setRecVersion()
     * @uses AxdEntity_DocuRefLine::setRefCompanyId()
     * @uses AxdEntity_DocuRefLine::setRefRecId()
     * @uses AxdEntity_DocuRefLine::setRefTableId()
     * @uses AxdEntity_DocuRefLine::setRestriction()
     * @uses AxdEntity_DocuRefLine::setSmmTable()
     * @uses AxdEntity_DocuRefLine::setTypeId()
     * @uses AxdEntity_DocuRefLine::setAction()
     * @param string $class
