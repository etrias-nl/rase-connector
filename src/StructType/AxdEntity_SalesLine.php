...
class AxdEntity_SalesLine extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \rase\StructType\AxdEntity_InventDim[]
     */
    public $InventDim;
    /**
     * The DocuRefLine
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \rase\StructType\AxdEntity_DocuRefLine[]
     */
    public $DocuRefLine;
    /**
     * The MarkupTransLine
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \rase\StructType\AxdEntity_MarkupTransLine[]
     */
     ...
     * @param \rase\StructType\AxdEntity_InventDim[] $inventDim
     * @param \rase\StructType\AxdEntity_DocuRefLine[] $docuRefLine
     * @param \rase\StructType\AxdEntity_MarkupTransLine[] $markupTransLine
     * @param string $action
     */
     ...
     * Set ItemId value
     * @param string $itemId
     * @return \rase\StructType\AxdEntity_SalesLine
     */
     ...
     * This property is removable from request (nillable=true+minOccurs=0), therefore
     * if the value assigned to this property is null, it is removed from this object
     * @uses \rase\EnumType\AxdExtType_LineStopped::valueIsValid()
     * @uses \rase\EnumType\AxdExtType_LineStopped::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $blocked
     * @return \rase\StructType\AxdEntity_SalesLine
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\rase\EnumType\AxdExtType_LineStopped::valueIsValid($blocked)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $blocked, implode(', ', \rase\EnumType\AxdExtType_LineStopped::getValidValues())), __LINE__);
        }
     ...
     * This property is removable from request (nillable=true+minOccurs=0), therefore
     * if the value assigned to this property is null, it is removed from this object
     * @uses \rase\EnumType\AxdExtType_TradeLineDlvTypeId::valueIsValid()
     * @uses \rase\EnumType\AxdExtType_TradeLineDlvTypeId::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $deliveryType
     * @return \rase\StructType\AxdEntity_SalesLine
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\rase\EnumType\AxdExtType_TradeLineDlvTypeId::valueIsValid($deliveryType)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $deliveryType, implode(', ', \rase\EnumType\AxdExtType_TradeLineDlvTypeId::getValidValues())), __LINE__);
        }
     ...
     * This property is removable from request (nillable=true+minOccurs=0), therefore
     * if the value assigned to this property is null, it is removed from this object
     * @uses \rase\EnumType\AxdEnum_InventRefType::valueIsValid()
     * @uses \rase\EnumType\AxdEnum_InventRefType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $inventRefType
     * @return \rase\StructType\AxdEntity_SalesLine
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\rase\EnumType\AxdEnum_InventRefType::valueIsValid($inventRefType)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $inventRefType, implode(', ', \rase\EnumType\AxdEnum_InventRefType::getValidValues())), __LINE__);
        }
     ...
     * This property is removable from request (nillable=true+minOccurs=0), therefore
     * if the value assigned to this property is null, it is removed from this object
     * @uses \rase\EnumType\AxdExtType_ReturnItemReplaced::valueIsValid()
     * @uses \rase\EnumType\AxdExtType_ReturnItemReplaced::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $itemReplaced
     * @return \rase\StructType\AxdEntity_SalesLine
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\rase\EnumType\AxdExtType_ReturnItemReplaced::valueIsValid($itemReplaced)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $itemReplaced, implode(', ', \rase\EnumType\AxdExtType_ReturnItemReplaced::getValidValues())), __LINE__);
        }
     ...
     * This property is removable from request (nillable=true+minOccurs=0), therefore
     * if the value assigned to this property is null, it is removed from this object
     * @uses \rase\EnumType\AxdExtType_ReturnAllowReservation::valueIsValid()
     * @uses \rase\EnumType\AxdExtType_ReturnAllowReservation::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $returnAllowReservation
     * @return \rase\StructType\AxdEntity_SalesLine
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\rase\EnumType\AxdExtType_ReturnAllowReservation::valueIsValid($returnAllowReservation)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $returnAllowReservation, implode(', ', \rase\EnumType\AxdExtType_ReturnAllowReservation::getValidValues())), __LINE__);
        }
     ...
     * This property is removable from request (nillable=true+minOccurs=0), therefore
     * if the value assigned to this property is null, it is removed from this object
     * @uses \rase\EnumType\AxdEnum_ReturnStatusLine::valueIsValid()
     * @uses \rase\EnumType\AxdEnum_ReturnStatusLine::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $returnStatus
     * @return \rase\StructType\AxdEntity_SalesLine
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\rase\EnumType\AxdEnum_ReturnStatusLine::valueIsValid($returnStatus)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $returnStatus, implode(', ', \rase\EnumType\AxdEnum_ReturnStatusLine::getValidValues())), __LINE__);
        }
    ...
    {
        // validation for constraint: enumeration
        if (!\rase\EnumType\AxdEnum_boolean::valueIsValid($salesTableLineUpdate)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $salesTableLineUpdate, implode(', ', \rase\EnumType\AxdEnum_boolean::getValidValues())), __LINE__);
        }
    ...
    {
        // validation for constraint: enumeration
        if (!\rase\EnumType\AxdEnum_NoYes::valueIsValid($scrap)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $scrap, implode(', ', \rase\EnumType\AxdEnum_NoYes::getValidValues())), __LINE__);
        }
     ...
     * This property is removable from request (nillable=true+minOccurs=0), therefore
     * if the value assigned to this property is null, it is removed from this object
     * @uses \rase\EnumType\AxdExtType_IntrastatTriangularDeal::valueIsValid()
     * @uses \rase\EnumType\AxdExtType_IntrastatTriangularDeal::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $statTriangularDeal
     * @return \rase\StructType\AxdEntity_SalesLine
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\rase\EnumType\AxdExtType_IntrastatTriangularDeal::valueIsValid($statTriangularDeal)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $statTriangularDeal, implode(', ', \rase\EnumType\AxdExtType_IntrastatTriangularDeal::getValidValues())), __LINE__);
        }
    ...
    /**
     * Get InventDim value
     * @return \rase\StructType\AxdEntity_InventDim[]|null
     */
    ...
    public function setInventDim(array $inventDim = array())
    {
        foreach ($inventDim as $axdEntity_SalesLineInventDimItem) {
            ...
            if (!$axdEntity_SalesLineInventDimItem instanceof \rase\StructType\AxdEntity_InventDim) {
                throw new \InvalidArgumentException(sprintf('The InventDim property can only contain items of \rase\StructType\AxdEntity_InventDim, "%s" given', is_object($axdEntity_SalesLineInventDimItem) ? get_class($axdEntity_SalesLineInventDimItem) : gettype($axdEntity_SalesLineInventDimItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \rase\StructType\AxdEntity_InventDim $item
     * @return \rase\StructType\AxdEntity_SalesLine
     */
    public function addToInventDim(\rase\StructType\AxdEntity_InventDim $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \rase\StructType\AxdEntity_InventDim) {
            throw new \InvalidArgumentException(sprintf('The InventDim property can only contain items of \rase\StructType\AxdEntity_InventDim, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
        $this->InventDim[] = $item;
        return $this;
    }
     ...
     * @return \rase\StructType\AxdEntity_DocuRefLine[]|null
     */
    ...
    public function setDocuRefLine(array $docuRefLine = array())
    {
        foreach ($docuRefLine as $axdEntity_SalesLineDocuRefLineItem) {
            // validation for constraint: itemType
            if (!$axdEntity_SalesLineDocuRefLineItem instanceof \rase\StructType\AxdEntity_DocuRefLine) {
                throw new \InvalidArgumentException(sprintf('The DocuRefLine property can only contain items of \rase\StructType\AxdEntity_DocuRefLine, "%s" given', is_object($axdEntity_SalesLineDocuRefLineItem) ? get_class($axdEntity_SalesLineDocuRefLineItem) : gettype($axdEntity_SalesLineDocuRefLineItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \rase\StructType\AxdEntity_DocuRefLine $item
     * @return \rase\StructType\AxdEntity_SalesLine
     */
    public function addToDocuRefLine(\rase\StructType\AxdEntity_DocuRefLine $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \rase\StructType\AxdEntity_DocuRefLine) {
            throw new \InvalidArgumentException(sprintf('The DocuRefLine property can only contain items of \rase\StructType\AxdEntity_DocuRefLine, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
     ...
     * @return \rase\StructType\AxdEntity_MarkupTransLine[]|null
     */
    ...
    public function setMarkupTransLine(array $markupTransLine = array())
    {
        foreach ($markupTransLine as $axdEntity_SalesLineMarkupTransLineItem) {
            // validation for constraint: itemType
            if (!$axdEntity_SalesLineMarkupTransLineItem instanceof \rase\StructType\AxdEntity_MarkupTransLine) {
                throw new \InvalidArgumentException(sprintf('The MarkupTransLine property can only contain items of \rase\StructType\AxdEntity_MarkupTransLine, "%s" given', is_object($axdEntity_SalesLineMarkupTransLineItem) ? get_class($axdEntity_SalesLineMarkupTransLineItem) : gettype($axdEntity_SalesLineMarkupTransLineItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \rase\StructType\AxdEntity_MarkupTransLine $item
     * @return \rase\StructType\AxdEntity_SalesLine
     */
    public function addToMarkupTransLine(\rase\StructType\AxdEntity_MarkupTransLine $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \rase\StructType\AxdEntity_MarkupTransLine) {
            throw new \InvalidArgumentException(sprintf('The MarkupTransLine property can only contain items of \rase\StructType\AxdEntity_MarkupTransLine, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
